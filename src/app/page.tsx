...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-gray-400 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <header className="p-6 text-center animate-fadeIn relative z-10">
        ...
        <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300"> Connect with me through different platforms </p>
